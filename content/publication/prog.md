...
* **p.150**, *Ejemplo 4.20* En la definición de la matriz compañera $\mathbf{C}$, en lugar de $\mathbf{I}_m$ y $\mathbf{0}_m$, debe ser $\mathbf{I}_{m-1}$ y $\mathbf{0}_{m-1}$, donde $\mathbf{I}_{m-1}$ es la matriz identidad de tamaño $(m-1)\times(m-1)$, y $\mathbf{I}_{m-1}$  es el vector de ceros de tamaño $m-1$.
